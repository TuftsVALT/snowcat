...
prpath = os.path.join(here, '..', '..', '56_sunspots_problem')
...
series = series.set_index('year', drop=True)
...
model = pf.ARIMA(data=series, ar=9, ma=0, target='sunspots', family=pf.Normal())
x =  model.fit('BBVI')
