 ...
 */
(function () {
    window._voder_visAnnotator = {};

    // possible annotations: "stroke", "regression_line", "quadrant_lines", "hull", "text_highlight"

    window._voder_visAnnotator.getPossibleAnnotationOptionsHTML = function(dataFact,visObject){
    ...
    window._voder_visAnnotator.annotateVis = function(dataFact,visObject,visDivId){
    ...
    window._voder_visAnnotator.clearAnnotations = function () {
    ...
    function getAnnotationOptions_BarChart(dataFact,visObject){
        ...
        let strokeCheckedVal = window._voder_globalVars.dataFactMap[dataFact.id]['annotationMap']['stroke'];
        let opacityCheckedVal = window._voder_globalVars.dataFactMap[dataFact.id]['annotationMap']['opacity'];
        let textHighlightCheckedVal = window._voder_globalVars.dataFactMap[dataFact.id]['annotationMap']['text_highlight'];
    ...
    function getAnnotationOptions_ColoredScatterplot(dataFact,visObject){
        let annotationOptionHTML = "";
        let quadrant_lineCheckedVal = window._voder_globalVars.dataFactMap[dataFact.id]['annotationMap']['quadrant_lines'];
        let regression_lineCheckedVal = window._voder_globalVars.dataFactMap[dataFact.id]['annotationMap']['regression_line'];
        let hullCheckedVal = window._voder_globalVars.dataFactMap[dataFact.id]['annotationMap']['hull'];
        let strokeCheckedVal = window._voder_globalVars.dataFactMap[dataFact.id]['annotationMap']['stroke'];
        let opacityCheckedVal = window._voder_globalVars.dataFactMap[dataFact.id]['annotationMap']['opacity'];
        let itemLabelCheckedVal = window._voder_globalVars.dataFactMap[dataFact.id]['annotationMap']['item_label'];
        let textHighlightCheckedVal = window._voder_globalVars.dataFactMap[dataFact.id]['annotationMap']['text_highlight'];
    ...
    function applyAnnotations_ColoredScatterplot(dataFact,visObject,visDivId){
        ...
        if(dataFact['type']=="QuadrantDistributionFact"){
            ...
            if(strokeCheckedVal=="checked" || opacityCheckedVal=="checked"){
                var midXVal = window._voder_globalVars.metadataMap[visObject.x.attribute]['domain'][parseInt(window._voder_globalVars.metadataMap[visObject.x.attribute]['domain'].length/2)];
                var midYVal = window._voder_globalVars.metadataMap[visObject.y.attribute]['domain'][parseInt(window._voder_globalVars.metadataMap[visObject.y.attribute]['domain'].length/2)];
    ...
    function applyAnnotations_SizedScatterplot(dataFact,visObject,visDivId){
        ...
        if(dataFact['type']=="QuadrantDistributionFact"){
            if(strokeCheckedVal=="checked" || opacityCheckedVal=="checked"){
                var midYVal = window._voder_globalVars.metadataMap[visObject.y.attribute]['domain'][parseInt(window._voder_globalVars.metadataMap[visObject.y.attribute]['domain'].length/2)];
                var midSizeVal = window._voder_globalVars.metadataMap[visObject.size.attribute]['domain'][parseInt(window._voder_globalVars.metadataMap[visObject.size.attribute]['domain'].length/2)];
                d3.select("#"+visDivId).selectAll(".dot")
