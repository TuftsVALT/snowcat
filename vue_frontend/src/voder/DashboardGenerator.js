...
(function(){
    ...
    window._voder_dashboardGenerator = {};

    window._voder_dashboardGenerator.generateSlideShowLayout = function(){
        //let savedVisualizations = window._voder_globalVars.mainSessionMap['visualizations'];
        let savedVisualizations = window._voder_globalVars.bookmarkedVisObjects;
    ...
    window._voder_dashboardGenerator.generateDashboardLayout = function(){
        let savedVisualizations = window._voder_globalVars.bookmarkedVisObjects;
    ...
    function renderAssociatedFacts_SlideLayout(){
        //let savedVisualizations = window._voder_globalVars.mainSessionMap['visualizations'];
        let savedVisualizations = window._voder_globalVars.bookmarkedVisObjects;
        //let dataFactMap = window._voder_globalVars.mainSessionMap['dataFactMap']
        let dataFactMap = window._voder_globalVars.bookmarkedDataFactMap;
