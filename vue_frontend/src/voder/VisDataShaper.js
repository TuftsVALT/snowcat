 ...
 */
(function(){
    window._voder_visDataShaper = {};

    window._voder_visDataShaper.getDataForBarChartWithCount = function(dataList, attribute){
        let labelCountMap = {};
    ...
    window._voder_visDataShaper.getDataForBarChartWithSum = function(dataList, labelAttribute, valueAttribute){
        let labelSumMap = {};
        for(var dataObject of dataList){
    ...
    window._voder_visDataShaper.getDataForBarChartWithAvg = function(dataList, labelAttribute, valueAttribute){
    ...
    window._voder_visDataShaper.getDataForSingleAxisTickPlot = function (dataList, yAttr, itemAttr) {
    ...
    window._voder_visDataShaper.getDataForTwoAxisTickPlot = function(dataList, xAttr, yAttr, itemAttr){
        let reshapedDataList = [];
        for(var dataObject of dataList){
    ...
    window._voder_visDataShaper.getDataForColoredTickPlot = function(dataList, xAttr, yAttr, colorAttr, itemAttr){
        let reshapedDataList = [];
        for(var dataObject of dataList){
            let label = dataObject[xAttr]
            let value = isNaN(dataObject[yAttr]) || dataObject[yAttr]=="" ? 0.0 : parseFloat(dataObject[yAttr]); // checking for missing and non-numeric values
    ...
    window._voder_visDataShaper.getDataForScatterplot = function(dataList, metadataMap, xAttr, yAttr, itemAttr){
        let reshapedDataList = [];
        for(var dataObject of dataList){
            let xVal;
    ...
    window._voder_visDataShaper.getDataForColoredScatterplot = function(dataList, metadataMap, xAttr, yAttr, colorAttr, itemAttr){
        let reshapedDataList = [];
        for(var dataObject of dataList){
            let xVal;
            if(metadataMap[xAttr]['type'] == "quantitative"){
    ...
    window._voder_visDataShaper.getDataForColoredScatterplotWithAvg = function(dataList, metadataMap, xAttr, yAttr, colorAttr, itemAttr){
        let reshapedDataList = [];
        let sumMap = {};
        let countMap = {};
    ...
    window._voder_visDataShaper.getDataForColoredTickPlotWithAvg = function(dataList, metadataMap, xAttr, yAttr, colorAttr, itemAttr){
        let reshapedDataList = [];
        let sumMap = {};
        let countMap = {};
    ...
    window._voder_visDataShaper.getDataForColoredScatterplotWithSum = function(dataList, metadataMap, xAttr, yAttr, colorAttr, itemAttr){
        let reshapedDataList = [];
        let sumMap = {};
        let countMap = {};
    ...
    window._voder_visDataShaper.getDataForColoredTickPlotWithSum = function(dataList, metadataMap, xAttr, yAttr, colorAttr, itemAttr){
        let reshapedDataList = [];
        let sumMap = {};
        let countMap = {};
    ...
    window._voder_visDataShaper.getDataForSizedScatterplot = function(dataList, metadataMap, xAttr, yAttr, sizeAttr, itemAttr){
        let reshapedDataList = [];
        for(var dataObject of dataList){
            let xVal;
            if(metadataMap[xAttr]['type'] == "quantitative"){
    ...
    window._voder_visDataShaper.getDataForAggregatedScatterplotByAvg = function(dataList,metadataMap,xAttr,yAttr,sizeAttr){
        let reshapedDataList = [];
        let sumMap = {};
        let countMap = {};
    ...
    window._voder_visDataShaper.getDataForAggregatedScatterplotBySum = function(dataList,metadataMap,xAttr,yAttr,sizeAttr){
        let reshapedDataList = [];
        let sumMap = {};
        let countMap = {};
    ...
    window._voder_visDataShaper.getDataForAggregatedScatterplotByCount = function(dataList,metadataMap,xAttr,yAttr){
        let reshapedDataList = [];
        let countMap = {};
    ...
    window._voder_visDataShaper.getDataForStackedBarChart = function(dataList, metadataMap, xAttr, colorAttr){
        let reshapedDataList = [];
        let countMap = {};
    ...
    window._voder_visDataShaper.getDataForSingleAxisBoxPlot = function(dataList,metadataMap,yAttribute,itemAttribute){
        let reshapedData = {};
    ...
    window._voder_visDataShaper.getDataForHistogram = function(dataList,metadataMap,yAttribute){
        let reshapedData = [];
        for(var dataObj of dataList){
