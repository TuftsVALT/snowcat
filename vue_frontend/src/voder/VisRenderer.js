...
(function () {
    // require("@/voder/vendor/d3.v4.min.js")

    window._voder_visRenderer = {};

    window._voder_visRenderer.renderVisualization = function(divId, orgVisObject, options){
        let visObject = window._voder_utils.cloneObj(orgVisObject);
        if(visObject.type==("BarWithCount")){
            visObject.shapedData = window._voder_visDataShaper.getDataForBarChartWithCount(window._voder_globalVars.dataList, visObject.x.attribute)
            renderBarChart(divId,visObject,options);
        }else if(visObject.type==("BarWithSum")){
            visObject.shapedData = window._voder_visDataShaper.getDataForBarChartWithSum(window._voder_globalVars.dataList,visObject.x.attribute,visObject.y.attribute);
            renderBarChart(divId,visObject,options);
        }else if(visObject.type==("BarWithAvg")){
            visObject.shapedData = window._voder_visDataShaper.getDataForBarChartWithAvg(window._voder_globalVars.dataList,visObject.x.attribute,visObject.y.attribute);
            renderBarChart(divId,visObject,options);
            ...
            visObject.shapedData = window._voder_visDataShaper.getDataForSingleAxisTickPlot(window._voder_globalVars.dataList,visObject.y.attribute,window._voder_globalVars.itemAttribute);
            renderTickChart(divId,visObject,options);
        }else if(visObject.type=="TwoAxisTickPlot"){
            visObject.shapedData = window._voder_visDataShaper.getDataForTwoAxisTickPlot(window._voder_globalVars.dataList,visObject.x.attribute,visObject.y.attribute,window._voder_globalVars.itemAttribute);
            renderTickChart(divId,visObject,options);
        }else if(visObject.type=="TickPlotWithColor"){
            visObject.shapedData = window._voder_visDataShaper.getDataForColoredTickPlot(window._voder_globalVars.dataList,visObject.x.attribute,visObject.y.attribute,visObject.color.attribute,window._voder_globalVars.itemAttribute);
            renderColoredTickChart(divId,visObject,options);
        }else if(visObject.type=="Scatterplot"){
            visObject.shapedData = window._voder_visDataShaper.getDataForScatterplot(window._voder_globalVars.dataList,window._voder_globalVars.metadataMap,visObject.x.attribute,visObject.y.attribute,window._voder_globalVars.itemAttribute);
            renderScatterplot(divId,visObject,options);
        }else if(visObject.type=="ScatterplotWithColor"){
            visObject.shapedData = window._voder_visDataShaper.getDataForColoredScatterplot(window._voder_globalVars.dataList,window._voder_globalVars.metadataMap,visObject.x.attribute,visObject.y.attribute,visObject.color.attribute,window._voder_globalVars.itemAttribute);
            renderColoredScatterplot(divId,visObject,options);
        }else if(visObject.type=="ScatterplotWithSize"){
            visObject.shapedData = window._voder_visDataShaper.getDataForSizedScatterplot(window._voder_globalVars.dataList,window._voder_globalVars.metadataMap,visObject.x.attribute,visObject.y.attribute,visObject.size.attribute,window._voder_globalVars.itemAttribute);
            renderSizedScatterplot(divId,visObject,options);
        }else if(visObject.type=="AggregatedScatterplotWithCountSize"){
            visObject.shapedData = window._voder_visDataShaper.getDataForAggregatedScatterplotByCount(window._voder_globalVars.dataList,window._voder_globalVars.metadataMap,visObject.x.attribute,visObject.y.attribute);
            renderAggregateScatterplot(divId,visObject,options);
        }else if(visObject.type=="AggregatedScatterplotWithAvgSize"){
            visObject.shapedData = window._voder_visDataShaper.getDataForAggregatedScatterplotByAvg(window._voder_globalVars.dataList,window._voder_globalVars.metadataMap,visObject.x.attribute,visObject.y.attribute,visObject.size.attribute);
            renderAggregateScatterplot(divId,visObject,options);
        }else if(visObject.type=="AggregatedScatterplotWithSumSize"){
            visObject.shapedData = window._voder_visDataShaper.getDataForAggregatedScatterplotBySum(window._voder_globalVars.dataList,window._voder_globalVars.metadataMap,visObject.x.attribute,visObject.y.attribute,visObject.size.attribute);
            renderAggregateScatterplot(divId,visObject,options);
        }else if(visObject.type=="StackedBarChart"){
            visObject.shapedData = window._voder_visDataShaper.getDataForStackedBarChart(window._voder_globalVars.dataList,window._voder_globalVars.metadataMap,visObject.x.attribute,visObject.color.attribute);
            renderStackedBarChart(divId,visObject,options);
        }else if(visObject.type=="ScatterplotWithColorByAvg"){
            visObject.shapedData = window._voder_visDataShaper.getDataForColoredScatterplotWithAvg(window._voder_globalVars.dataList,window._voder_globalVars.metadataMap,visObject.x.attribute,visObject.y.attribute,visObject.color.attribute,window._voder_globalVars.itemAttribute);
            renderColoredScatterplot(divId,visObject,options);
        }else if(visObject.type=="ScatterplotWithColorBySum"){
            visObject.shapedData = window._voder_visDataShaper.getDataForColoredScatterplotWithSum(window._voder_globalVars.dataList,window._voder_globalVars.metadataMap,visObject.x.attribute,visObject.y.attribute,visObject.color.attribute,window._voder_globalVars.itemAttribute);
            renderColoredScatterplot(divId,visObject,options);
        }else if(visObject.type=="TickPlotWithColorByAvg"){
            visObject.shapedData = window._voder_visDataShaper.getDataForColoredTickPlotWithAvg(window._voder_globalVars.dataList,window._voder_globalVars.metadataMap,visObject.x.attribute,visObject.y.attribute,visObject.color.attribute,window._voder_globalVars.itemAttribute);
            renderColoredTickChart(divId,visObject,options);
        }else if(visObject.type=="TickPlotWithColorBySum"){
            visObject.shapedData = window._voder_visDataShaper.getDataForColoredTickPlotWithSum(window._voder_globalVars.dataList,window._voder_globalVars.metadataMap,visObject.x.attribute,visObject.y.attribute,visObject.color.attribute,window._voder_globalVars.itemAttribute);
            renderColoredTickChart(divId,visObject,options);
        }else if(visObject.type=="SingleAxisBoxPlot"){
            visObject.shapedData = window._voder_visDataShaper.getDataForSingleAxisBoxPlot(window._voder_globalVars.dataList,window._voder_globalVars.metadataMap,visObject.y.attribute,window._voder_globalVars.itemAttribute);
            renderSingleAxisBoxPlot(divId,visObject,options)
        }else if(visObject.type=="Histogram"){
            visObject.shapedData = window._voder_visDataShaper.getDataForHistogram(window._voder_globalVars.dataList,window._voder_globalVars.metadataMap,visObject.y.attribute);
    ...
    function renderScatterplot(divId, visObject, options){
        ...
        if(window._voder_globalVars.metadataMap[visObject.x.attribute]['type']!="quantitative"){
        ...
        let midXVal = window._voder_globalVars.metadataMap[visObject.x.attribute]['domain'][parseInt(window._voder_globalVars.metadataMap[visObject.x.attribute]['domain'].length/2)];
        let midYVal = window._voder_globalVars.metadataMap[visObject.y.attribute]['domain'][parseInt(window._voder_globalVars.metadataMap[visObject.y.attribute]['domain'].length/2)];
